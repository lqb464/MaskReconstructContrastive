...
def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m swin_unet.src.ver4.cli",
        description="Unified ver4 CLI for SSL train/eval and task-specific training.",
    )
    parser.add_argument(
        "command",
        nargs="?",
        help="Subcommand: train-ssl | eval-ssl | train-cls | train-skull | train-tissue",
    )
