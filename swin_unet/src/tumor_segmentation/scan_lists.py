...
_MODALITY_SUFFIX_RE = re.compile(r"_(t1ce|flair|t1|t2|cer|hyper)$", re.IGNORECASE)
ALL_MODALITIES: Tuple[str, ...] = ("t1", "t1ce", "t2", "flair", "cer", "hyper")
...
_SLICE_MODALITY_RE = re.compile(r"^(.+)_(t1ce|flair|t1|t2|cer|hyper)_(z\d+)$", re.IGNORECASE)
