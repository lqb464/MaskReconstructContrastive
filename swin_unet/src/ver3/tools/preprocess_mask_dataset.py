...
from ..mask_reconstruction.io import load_mask_array

DATASET_VERSION = "mask_reconstruction_preprocessed_v1"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="python -m swin_unet.src.ver3.tools.preprocess_mask_dataset",
        description="Offline preprocessing for ver3/mask_reconstruction image-mask pairs.",
    )
