...
class UNetDualViewSSL(nn.Module):
    """
    UNet backbone adapter for the autoencoder trainer interface.
    Dual-view reconstruction with skip connections and skip masking in the decoder.
    """
...
__all__ = ["UNetDualViewSSL", "_ResBlock", "_UpBlock"]
